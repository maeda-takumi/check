    ...
    <?php else: ?>
      ...
      <?php else: ?>
        ...
        <?php if (!empty($questionsByGroup[(int)$selectedGroup['group_id']])): ?>
          <div class="question-edit-list question-edit-list-wide">
            <?php foreach ($questionsByGroup[(int)$selectedGroup['group_id']] as $question): ?>
              <div class="question-edit-row <?= (int)$question['is_active'] === 0 ? 'is-inactive' : ''; ?>">
                <form method="post" class="question-edit-inline-form">
                  ...
                  <div class="question-edit-main">
                    ...
                    <label class="required-check"><input type="checkbox" name="required" value="1" <?= (int)$question['required'] === 1 ? 'checked' : ''; ?>> 必須</label>
